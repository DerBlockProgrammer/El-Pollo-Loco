class Endboss extends MovableObject {
    ...
    die() {
        this.isDead = true;
        // Можно добавить анимацию смерти или звуковой эффект здесь
        // Например, запустить fade-out эффект, а затем удалить босса из мира.
    }
    
    draw(ctx) {
        // Если босс мёртв, не отрисовываем его (или отрисовываем эффект смерти)
        if (this.isDead) {
            return;
        }
